...
class TrunkProcedures2():
    ...
    def refresh(self):
        # TrunkProcedures2.refresh.message = ''
        message = ''
        ...
        # trunk_q = self.trunk_model.objects.all()
...
class Schema:
    ...
    def __init__(self, app_label='eprectest'):
        ...
        # adding 'message' property to all function objects methods of this class
    ...
    def last_schema_graph_ids(self):
        ...
        converts adjacent bunches items to ids from Trunk in place
        """
    ...
    def schema_graph_changes(self):
        """ return True content of "bunches" (adjacent items) from last_schema.json
    ...
    def create_branches_bunches(self):
        ...
        with open(self.last_schema_filepath, 'r') as json_schema:
            schema = json.load(json_schema)
        # get branches names from json_schema
        branches_names = [branch_name for branch_name in schema['branches']]
